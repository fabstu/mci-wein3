...
public class UnterfensterController {
    ...
    public void nehmeWeinAuf(WeinController weinController) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(UnterfensterController.class.getResource("../aufnehmen/WeinAufnehmen.fxml"));
    ...
    public void zeigeListe(WeinController weinController, List<Wein> weinListe) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(UnterfensterController.class.getResource("../liste/WeinListe.fxml"));
        Parent root = fxmlLoader.load();
